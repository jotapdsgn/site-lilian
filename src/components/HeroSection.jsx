    ...
    <section className="relative bg-hero-bg pt-4 pb-6 lg:pt-32 lg:pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center lg:items-center">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="w-full lg:w-1/2 order-2 lg:order-1 text-center lg:text-left mt-2"
        >
          ...
          >
            ...
            <span className="block mt-1 font-normal italic text-gold">
              com naturalidade
            </span>
          </motion.h1>
